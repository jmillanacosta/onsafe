 ...
 * [onsafe.yml](onsafe.yml)
     * Determines how your purl.obolibrary.org/obo/onsafe/ redirects will be handled
     ...
     * Paste in the contents of [onsafe.yml](onsafe.yml)
 ...
 * [onsafe.md](onsafe.md)
     ...
     * Paste in the contents of [onsafe.md](onsafe.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
